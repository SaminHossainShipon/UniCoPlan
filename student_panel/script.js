...
// The student panel has no login gate — it's open access, same as any public
// course-planning page. (The admin panel still requires Google Sign-In, since
// it's the one that edits the shared course datasheet.)
