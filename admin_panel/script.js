...
const state = {
  ...
  adminPage: 'dashboard',   // 'dashboard' | 'semesters' | 'datasheet' | 'students' | 'access'
  semesters: [],
  adminSemesterId: null,
  studentSemesterId: null,
  studentPage: 'plan',      // 'profile' | 'plan' | 'timetable' | 'combinations'
...
function bindAdminEvents(){
  ...
  // Fetches the Dashboard stats / Student directory the first time either
  // page is shown — whether that's from clicking its tab, or from landing on
  // 'dashboard' straight after sign-in, since it's the default admin page.
  // The loaded flags keep this from re-fetching on every re-render.
